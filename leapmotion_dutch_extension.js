...
(function (ext) {
  ...
  var descriptor = {
    blocks: [
      ...
      ['-'],
      ['r', '%m.hands %m.fingers x positie', 'getFingerX', 'hand A', 'finger 1'],
      ['r', '%m.hands %m.fingers y positie', 'getFingerY', 'hand A', 'finger 1'],
      ['r', '%m.hands %m.fingers z positie', 'getFingerZ', 'hand A', 'finger 1'],
      ['b', '%m.hands %m.fingers is uitgebreid?', 'isFingerExtended', 'hand A', 'finger 1'],
      ['-'],
