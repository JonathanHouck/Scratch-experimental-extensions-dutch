...
(function (ext) {
  ...
  var descriptor = {
    blocks: [
      ['r', '%m.hands x positie', 'getHandX', 'hand A'],
      ['r', '%m.hands y positie', 'getHandY', 'hand A'],
      ['r', '%m.hands z positie', 'getHandZ', 'hand A'],
      ['r', '%m.hands draairichting', 'getHandRotation', 'hand A'],
      ['b', '%m.hands is zichtbaar?', 'isHandVisible', 'hand A'],
      ['b', '%m.hands is gesloten?', 'isHandGrabbed', 'hand A'],
      ['-'],
      ['r', '%m.hands %m.fingers x positie', 'getFingerX', 'hand A', 'vinger 1'],
      ['r', '%m.hands %m.fingers y positie', 'getFingerY', 'hand A', 'vinger 1'],
      ['r', '%m.hands %m.fingers z positie', 'getFingerZ', 'hand A', 'vinger 1'],
      ['b', '%m.hands %m.fingers is uitgebreid?', 'isFingerExtended', 'hand A', 'vinger 1'],
      ['-'],
      ['r', '%m.tools x positie', 'getToolX', 'tool A'],
      ['r', '%m.tools y positie', 'getToolY', 'tool A'],
      ['r', '%m.tools z positie', 'getToolZ', 'tool A'],
    ...
    menus: {
      hands: ['hand A', 'hand B'],
      fingers: ['vinger 1', 'vinger 2', 'vinger 3', 'vinger 4', 'vinger 5'],
      tools: ['tool A', 'tool B'],
      gestures: ['tik', 'por', 'veeg', 'cirkel']
    },  
    url: 'https://github.com/JonathanHouck/scratch-experimental-extensions-dutch'
  };
